...
impl Config {
    pub fn load() -> LoadedConfig {
        ...
        // Upstream's read_optional_config helper cleanly separates
        // not-present (None) from read errors; the fork's parse path then
        // salvages valid sections on a malformed modal `[keys]` block.
