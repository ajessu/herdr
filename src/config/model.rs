...
//
// TODO(upstream-merge): port three upstream keybind behaviors into this modal
// schema — 088922d (user-keybinds-displace-defaults: BindingSource/RegisteredBinding),
// b708f85 (shifted indexed-number matching), 32e3d7b (compact indexed help ranges).
// TODO(upstream-merge): port upstream `remote_image_paste: String` (ed31632,
// local-client clipboard-image shortcut) into the modal schema + its Default/overlay.
