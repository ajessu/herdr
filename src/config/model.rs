...
//
// TODO(upstream-merge): port 088922d (user-keybinds-displace-defaults:
// BindingSource/RegisteredBinding, KeysConfigOverlay user-provenance profile)
// into this modal schema. 32e3d7b (compact indexed help ranges) also pending.
...
pub struct KeysConfig {
    ...
    /// Raw-key clipboard-image paste shortcut, only active in `herdr --remote`
    /// local clients. Empty disables it. Default: "ctrl+v".
