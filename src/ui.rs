...
pub(crate) use self::{
    ...
    sidebar::{
        agent_panel_body_rect, agent_panel_entries, agent_panel_item_rows,
        agent_panel_scroll_metrics, agent_panel_scrollbar_rect, agent_panel_toggle_rect,
        collapsed_detail_content_area, collapsed_detail_window, collapsed_sidebar_sections,
        collapsed_sidebar_toggle_rect, collapsed_ws_window, compute_workspace_card_areas,
        expanded_sidebar_sections, expanded_sidebar_toggle_rect, is_attention_state,
        normalized_workspace_scroll, sidebar_section_divider_rect, workspace_list_entries,
